package com.apuntes.apuntes.security.entity;
...
public class UsuarioMain implements UserDetails {
    ...
    //Constructor
    public UsuarioMain(int idUsuario, String nombre, String usuario, String email, String password, Collection<? extends GrantedAuthority> authorities) {
    ...
    public static UsuarioMain build(Usuario usuario){
        ...
        return new UsuarioMain(usuario.getIdUsuario() ,usuario.getNombre(), usuario.getUsuario(), usuario.getEmail(),
